...
function getData(){
  d3.json("https://organized-alluring-nerine.glitch.me/posts", function(data) {
      ...
      var enteringElements= update.enter();
      var username = text.enter();
      var robot = graphGroupI.selectAll(".robot").data(data);
      var r1 = robot.enter();
      var robot2 = graphGroupI.selectAll(".robotR").data(data);
      var r2 = robot2.enter();
                    //
               enteringElements
               .append("svg:image")
...
if((d.likes.length+d.replies.length)>=0&&(d.likes.length+d.replies.length)<20){
  ...
  return 250+(d.likes.length+d.replies.length-45)*10;
                    ...
                    console.log(update);
                      ...
                      //     }}});
                      //
                      // graphGroupI.selectAll(".robot").data(data).enter()
                      //       .append("image")
                      //       .attr("class","robot")
                      //       .attr("xlink:href", function(d){
                      //           if(d.likes.length>0){
                      ...
                      //       ;
                      //
      //                 graphGroupI.selectAll(".robotR").data(data).enter()
      //                 .append("image")
      //                 .attr("class","robotR")
      //                 .attr("xlink:href", function(d){
    ...
    // let robot = graphGroupI.selectAll(".robot").data(data);
    // let r1 = robot.enter();
    // let robot2 = graphGroupI.selectAll(".robotR").data(data);
    // let r2 = robot2.enter();
